...
const navigation = [
  ...
  { name: "Voting", href: "/voting", icon: FolderIcon, current: false },
  { name: "Results", href: "/results", icon: CalendarIcon, current: false },
];
const teams = [
      ...
      <div>
            ...
            <div className="fixed inset-0 flex">
              ...
              >
                <DialogPanel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-100 px-6 pb-4 ring-1 ring-white/10 shadow-sm">
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-100 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">
              <Link href="/">tfhe voting system</Link>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-600 bg-background px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form className="relative flex flex-1" action="#" method="GET">
                ...
                <input
                  id="search-field"
                  className="block h-full w-full border-0 py-0 pl-8 pr-0 text-black bg-background placeholder:text-gray-400 focus:ring-0 sm:text-sm"
                  placeholder="Search..."
                  type="search"
                  name="search"
                />
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <Menu as="div" className="relative">
                  ...
                  >
                    <MenuItems className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-background text-black py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
